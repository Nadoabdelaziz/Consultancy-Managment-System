                  ...
                  <div class="col-lg-12" >
                    ...
                    <div class="col-lg-4" style="float: right;">
                      ...
                      <div class="art-a art-blog-card">
                        <!-- post cover -->
                        <a target="__blank" href="{{ (isset($my_service->video)) ? url($my_service->video) : ''}}" class="art-port-cover">
                          <!-- img -->
                          <img src="{{(isset($my_service->vid_cover)) ? asset('storage/'. $my_service->vid_cover) : ''}}" alt="blog post">
                        </a>
                        <!-- post cover end -->
                        <!-- post description -->
