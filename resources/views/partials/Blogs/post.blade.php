...
">
            ...
            <div class="row" style="/* float: left; */height: 150px;width: min-content;display: inline-flex;"><label
                        ...
                        <div class="frame-content">
                            ...
                            <div
                                ...
                                <div class="row" style="justify-content: space-between;">
                                    <img src="https://res.cloudinary.com/dxdc8azyj/image/upload/v1661717757/bank_owt3ot.png"
                                        style="
                            padding: 21px;
                            padding-left: 45px;
                            width: 35%;">
                                    <h2
                                        style="/*background-color: #404040; width: 100%; */border-radius: 20px;/* margin-bottom: 20px; *//* margin: auto; */padding: 56px;">
                                        {{__('Data of Bank Transfer')}}</h2>
                                </div>
                            ...
                            width: 93%;">
                                <div class="row" style="justify-content: end;">
                                    <h3
                                        style="/*background-color: #404040; width: 100%; */border-radius: 20px;/* margin-bottom: 20px; *//* margin: auto; */font-weight: 300;padding: 39px;">
                                        معلومات الدفع البنكية</h3>
                                </div>

                                <div class="row" style="justify-content: end;">
                                    <h4
                                        style="/*background-color: #404040; width: 100%; */border-radius: 20px;/* margin-bottom: 20px; */color: darkgray;/* margin: auto; */font-weight: revert;padding-bottom: 27px;padding-right: 39px;">
                                        : {{__('Name of account owner')}}</h4>
                                </div>
                                ...
                                <div style="background-color: transparent;width: fit-content;display: contents;">
                                    <label for="frame1" class=""
                                        style="background-color:#FFC107; color:black; height: 45px;width: 220px;font-size: x-large;margin: 20px;padding: 21px;">انتقل
                                        إلى التنفيذ</label>
                                </div>
                        ...
                        <div class="frame-content">
                            ...
                            <form action="PlacesCons" method="post" enctype="multipart/form-data"
                                ...
                                <div class="art-form-field"
                                    ...
                                    <div style="margin: 10px; overflow-y: 20px;padding: 10px;border-radius: 20px;">
                                        ...
                                        <div id="text-1" class="row"
                                            ...
                                            <input
                                                style="border-radius: 6px;width: -webkit-fill-available;/* margin: 2px; */font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                    ...
                                    <div class="art-form-field" style="margin: 10px;padding: 10px;border-radius: 20px;">
                                        ...
                                        <div class="row"
                                            ...
                                            <input type="text"
                                                style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                                name="country"
                                                placeholder="{{isset($info) ? $info->country :__('enter country')}}">
                                        </div>
                                ...
                                <div style="background-color: transparent;width: fit-content;display: contents;">
                                    ...
                                    <button class="" onclick="mfunction()"
                            ...
                            <div class="frame-content" style="background-color: #252532;border-radius: 20px;">
                                <div class="row art-form-field"
                                    ...
                                    <label for="frame3"
                                        style="color:black; width: max-content;margin-top: 16px;/* padding-top: 20px; *//* margin-bottom: 20px; *//* display: revert; */padding: 20px;font-weight: 800;font-size: x-large;background-color: #FFC107;border-radius: 12px;">انتقل
                                        إلى عرض السعر</label>
                                </div>
