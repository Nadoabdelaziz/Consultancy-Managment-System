...
<div id="bullets">
            <label for="frame1">4</label>
            <label for="frame2">3</label>
            <label for="frame3">2</label>
            <label for="frame4">1</label>
        </div>
        <br><br>
                    ...
                    <div class="frame frame_1">
                        <div class="frame-content">
                          ...
                          <form style="margin-top: 250px;">
                            <h2>List</h2>
                            <textarea name="asd" id="" cols="20" rows="20" style="margin-bottom: 12px;height: 200px;width: 550px;">enter here</textarea>
                            <!-- User ID : <input type = "text" name = "user_id" /> -->
                            <br>
                            <!-- Password: <input type = "password" name = "password" /> -->                           
