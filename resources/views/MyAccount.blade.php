                ...
                ?>
                  ...
                  <div class="col-lg-12">
                    <div class="alert alert-primary" role="alert">
                      <h5 style="color: lightslategrey;text-align-last: end;" class="mb-0">{{__('Authenticate the email to activate the location services and correct communication')}}</h5>
                    </div>                  
                  </div>
                  ...
                  <div class="col-lg-7">
                    ...
                    <div class="art-timeline-item">
                      ...
                      <div class="art-a art-timeline-content" style="">
                          <div class="art-table p-15-15" style="
                              text-align: -webkit-right;">
                                ...
                                <ul style="width: 100%;">
                                  ...
                                  <li style="margin-bottom: 25px;">
                                  <h5 style="color: white;"><a href="#">{{__('Edit')}}</a></h5>
                                  <h5 style="font-weight: bolder;">{{isset($C_User->name) ? __($C_User->email) : '' }}</h5>
                      ...
                      <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">  
                          <h5 style="text-align: center;"><a href="">{{__('Change Password')}}</a></h5>
                        </div>
                      </div>
                  ...
                  <div class="col-lg-5">
                    ...
                    <div class="art-timeline">
                      ...
                      <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">
                          <img src="{{asset('storage/'.$C_User->avatar)}}" alt="" style="width: -webkit-fill-available;border-radius: 141px;">
                            <div class="art-card-header" style="margin-top: 36px;justify-content: center;/* width: 70%; */">
                              <div class="art-left-side" style="">
                              <h5 class="mb-15">{{isset($C_User->name) ? __($C_User->name) : '' }}</h5>
                                <div style="text-align-last: center;" class="art-el-suptitle mb-25">{{isset($C_User->mobile_number) ? ($C_User->mobile_number) : '' }}</div>
                                <li style="/* margin-bottom: 25px; *//* isolation: auto; *//* display: flex; *//* width: 81%; */">
                                    <h4 style="/* margin-right: 10px; */float: left;">{{__($C_User->city)}}</h4>
                                    <h4 style="text-align: `;float: right;"> : {{__('City')}}</h4>
                                  </li>
                              </div>
                            </div>
                      ...
                      <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">                     
                          <li style="margin-bottom: 25px;">
                              <h5 style="width: fit-content;float: left;">{{$C_User->created_at->toDateString()}}</h5>  
                              <h4 style="width: fit-content;float: right;">: {{__('Registeration Date')}}</h4>
                          </li>
                          <li style="margin-bottom: 25px;">
                              <h5 style="width: fit-content;float: left;">{{$C_User->created_at->toDateString()}}</h5>  
                              <h4 style="width: fit-content;float: right;">: {{__('Latest Sign In')}}</h4>
                          </li>
                        </div>
